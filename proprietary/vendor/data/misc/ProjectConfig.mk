...
MTK_TABLET_EMMC_ACTIVE_BOOT_PART = no
...
CUSTOM_KERNEL_IMGSENSOR = gc2023_mipi_raw tp2825_yuv
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = cpt_1024x600_lvds
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc2023_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = tp2825_yuv
...
CUSTOM_LK_LCM = CPT_1024x600_LVDS
CUSTOM_MODEM =
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = CPT_1024x600_LVDS
DCORE_TEST_MODE1 = no
...
MTK_BT_CHIP = MTK_CONSYS_AC8227L
MTK_BT_CUSTOM = yes
...
MTK_BUILD_VERNO = ZXDZ_$(shell date +%Y.%m.%d.%H)
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
ATC_AUDIOIN_SUPPORT = no
ATC_ADOPTABLE_DISK = ext_sdcard2
ATC_SW_WP_SUPPORT = yes
HCN_ARMAUDIO_USED = yes
#adupsfota start
...
#adupsfota end
BUILD_OVERSEAS = yes
# PUBLIC AUDIOSISTEMI TAKARA REIS TOMIKO ANDERMIRO HARDSTONE MegaAudio Simplex Wings
HCN_BUILD_CUSTOMER=PUBLIC